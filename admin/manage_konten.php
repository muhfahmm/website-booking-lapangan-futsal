...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    <div class="max-w-2xl w-full p-8 bg-white rounded-lg shadow-md">
        <h1 class="text-3xl font-bold text-emerald-600 mb-6">Kelola Konten</h1>
        <p class="text-gray-700">Halaman ini akan menampilkan daftar konten dan aksi CRUD. Saat ini masih placeholder.</p>
